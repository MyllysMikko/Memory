...
public class SaveManager
{
    ...
    //But I like to use playerPrefs to save options (Player preferences like the name implies) and have save data be separate from that.
    public int LoadData()
    {
        ...
        if (File.Exists(filePath))
        {
            ...
            //Incase something has gone wrong with the save file (Such as the user modifying it) we return a default value of 0.
